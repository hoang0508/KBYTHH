...
<?php
    if(isset($_GET['xoa'])) {
      $id = $_GET['xoa'];
      $sql_delete_giangvien = mysqli_query($conn, "DELETE FROM tbl_giangvien WHERE id_giangvien = '$id'");
    }
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <div class="row">
       <?php
        if(isset($_GET['quanly'])=='xemgiangvien') {
          $magv = $_GET['magv'];
          $sql_chitiet = mysqli_query($conn, "SELECT * FROM tbl_giangvien WHERE magiangvien = '$magv'");
        ?> 
        <div class="col-md-12 mb-3">
          <p style="font-size: 20px;">Xem chi tiết sinh vien</p>
            ...
            ?>
              <tr style="text-align:center">
                <td><?php echo $i ?></td>
                <!-- <td><?php echo $row_ctsv['magiangvien'] ?></td> -->
               ...
               ?>
                ...
                <td><?php echo $row_ctsv['sodienthoai'] ?></td>
                <td><?php echo $row_ctsv['ngaysinh'] ?></td>
                <td>
                  <?php
                  if($row_ctsv['t_sot'] == 1) {
      ...
      <?php
        $sql_select = mysqli_query($conn, "SELECT * FROM tbl_giangvien");
      ?>
        <table class="table table-bordered">
          <tr style="text-align:center">
            <th>STT</th>
          ...
          ?>
            <tr style="text-align:center">
              ...
              <td><?php echo $row_khaibaosv['sodienthoai'] ?></td>
              ...
              <td><?php echo $row_khaibaosv['magiangvien'] ?></td>
              <td><?php echo $row_khaibaosv['phongban'] ?></td>
              <td>
              <?php 
              ...
              <td style="text-align: center;"><a style="font-size: 14px;display:block;" href="?xoa=<?php echo $row_khaibaosv['id_giangvien'] ?>" class="btn btn-danger mb-2"><i class="fa fa-trash" aria-hidden="true"></i></a> <a href="?quanly=xemgiangvien&magv=<?php echo $row_khaibaosv['magiangvien'] ?>" style="font-size: 14px;display:block" class="btn btn-primary">Xem Chi tiết</a></td>
            </tr>
            <?php
            }
            ?>
